...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      username: 'Katharina70',
      password: 'IanKmvpI8cTFAh8',
      email: 'Vilma44@hotmail.com',
      name: 'Roman Torphy',
      mobileNo: '(438) 338-0346',
      role: 446,
      resetPasswordLink: {},
      loginRetryLimit: 999,
      loginReactiveTime: '2022-05-02T06:12:34.181Z',
      id: '61f2271b06522bd4cd5fbb2f'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Dangelo.Schowalter91',
        'password':'npDZz3j9iKrcP50',
        'email':'Saige_Nader@yahoo.com',
        'name':'Vanessa Fisher',
        'mobileNo':'(339) 857-2642 x041',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Saige_Nader@yahoo.com', });
